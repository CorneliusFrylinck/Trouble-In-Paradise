    ...
    public static class SeedTestUserExtension
    {
        public static ModelBuilder SeedTestUser(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ResourceItem>().HasData(
                new ResourceItem("Cement", 0, 500, 1, 1),
                new ResourceItem("Metal", 0, 500, 1, 2),
                new ResourceItem("Lumber", 0, 500, 1, 3),
                new ResourceItem("Water", 0, 500, 1, 4),
                new ResourceItem("Food", 0, 500, 1, 5),
                new ResourceItem("Oxygen", 0, 500, 1, 6),
                new ResourceItem("Blue_Crystal", 0, 500, 1, 7),
                new ResourceItem("Red_Crystal", 0, 200, 1, 8),
                new ResourceItem("Gold", 0, 5, 1, 9),
                new ResourceItem("Cement", 0, 500, 1, 10),
                new ResourceItem("Metal", 0, 500, 1, 11),
                new ResourceItem("Lumber", 0, 500, 1, 12),
                new ResourceItem("Water", 0, 500, 1, 13),
                new ResourceItem("Food", 0, 500, 1, 14),
                new ResourceItem("Oxygen", 0, 500, 1, 15),
                new ResourceItem("Blue_Crystal", 0, 500, 1, 16),
